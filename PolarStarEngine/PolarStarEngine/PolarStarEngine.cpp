...
void PolarStarEngine::display_splash_screen() {
	...
	if (!image.loadFromFile("..\\Assets\\polarstar.jpg"))
	{
...
void PolarStarEngine::setup_scene() {
	...
	GameObject* somaone = new GameObject("Soma", nullptr);
	SpriteRenderer* sprite_renderer = new SpriteRenderer();
	sprite_renderer->set_sprite("..\\Assets\\Soma.png");
	somaone->add_component(sprite_renderer);
	...
	somaone->add_component(box_collider);

	Rigidbody* rigidbody = new Rigidbody();
	rigidbody->mass = 0.0f;
	rigidbody->bounciness = 0.6f;
	somaone->add_component(rigidbody);
	somaone->transform->setPosition(300.0f, 100.0f);

	GameObject* somatwo = new GameObject("Soma2", nullptr);
	SpriteRenderer* sprite_renderer2 = new SpriteRenderer();
	sprite_renderer2->set_sprite("..\\Assets\\Soma.png");
	somatwo->add_component(sprite_renderer2);
	...
	somatwo->add_component(box_collider2);
	...
	somatwo->add_component(rigidbody2);
	somatwo->transform->setPosition(600.0f, 100.0f);
